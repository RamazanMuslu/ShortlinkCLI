...
# Bu dosya, Linux versiyonunun birebir aynısıdır. 
# Gerçek optimizasyon/platform farkı olmadığı sürece bu normaldir.
# Sadece kurulum scriptlerinin kolaylığı için ayrı tutulmuştur.
...
def shorten(long_url):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Check for API-returned error message
